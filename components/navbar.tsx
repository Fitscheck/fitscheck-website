  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm font-sans">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        {/* Logo */}
        <Link href="/" className="text-2xl font-extrabold text-pink-500 tracking-tight">
          FitsCheck
        </Link>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white shadow-sm">
          <div className="container flex flex-col gap-4 p-4">
            <Link
              ...
              className={`text-sm font-medium ${isActive("/") ? "text-pink-500" : "text-gray-600 hover:text-pink-500"}`}
            >
              Home
            </Link>
            <Link href="#features" onClick={() => setIsMenuOpen(false)} className="text-sm font-medium text-gray-600 hover:text-pink-500">
              Features
            </Link>
            <Link href="#pricing" onClick={() => setIsMenuOpen(false)} className="text-sm font-medium text-gray-600 hover:text-pink-500">
              Pricing
            </Link>

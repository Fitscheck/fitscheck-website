...
export const metadata: Metadata = {
  ...
  description:
    "Join FitsCheck - the social fashion platform where the community votes on your outfits through crowd-sourced style decisions. Post fits, compete in challenges, climb leaderboards.",
  icons: {
    icon: [
      {

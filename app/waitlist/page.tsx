              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Be the first to know when our social fashion platform launches. Share your style, get feedback, and
                ...
                <div className="flex items-center gap-4">
                  <div className="flex -space-x-2">
                    <div className="h-8 w-8 rounded-full border-2 border-white bg-pink-100"></div>
                    <div className="h-8 w-8 rounded-full border-2 border-white bg-blue-100"></div>
                    <div className="h-8 w-8 rounded-full border-2 border-white bg-green-100"></div>
                    <div className="h-8 w-8 rounded-full border-2 border-white bg-purple-100"></div>
                  </div>
            ...
            <div className="mx-auto mt-12 grid max-w-3xl gap-6">
              <div className="rounded-lg border border-gray-200 bg-white p-6">
                ...
                <p className="mt-2 text-gray-500">
                  We're planning to launch the beta version in Summer 2023, with a full public release in Fall 2023.
                </p>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white p-6">
                <h3 className="text-lg font-medium">Will the app be free to use?</h3>
                <p className="mt-2 text-gray-500">
                  Yes! FitsCheck will have a free tier with core features. Premium features will be available for
                  $4.99/month.
                </p>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white p-6">
